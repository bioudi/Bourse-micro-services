...
for d in data:
    ...
    for d in data_nbre_actions:
        ...
        if(nbre != "-"):
            ...
            requests.get("http://localhost:8882/save?prix_action="+price+"&qte="+qte+"&date_ordre="+date_ordre+"&nbre_actions="+nbre+"&code_societe="+code_societe+"&type_ordre=Achat")
            print "Row Inserted"
        cc+=1
    ...
    for d in data_nbre_actions_V:
        ...
        if(nbre_V != "-"):
            ...
            requests.get("http://localhost:8882/save?prix_action="+price_V+"&qte="+qte_V+"&date_ordre="+date_ordre+"&nbre_actions="+nbre_V+"&code_societe="+code_societe+"&type_ordre=Vente")
            print "Row Inserted"
        cc+=1
